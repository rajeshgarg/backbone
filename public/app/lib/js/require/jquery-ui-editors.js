define([ "order!jquery"
    ...
    , "order!backbone"
    , "order!tibbr"
    , "order!require/backbone-forms"
    , "order!require/jquery-ui"
    , "views/common/auto_suggest"
]
    , function ($, _, Backbone, Tibbr, BForm, $UI, AutoSuggest) {
        return (function () {
        ...
        '),
            ...
            //tibbr modification
            exports.TextField = Form.editors.Text.extend();

            exports.Subjectsd = Form.editors.Select.extend({
                initialize:function (options) {
                    Base.prototype.initialize.call(this, options);
            ...
            exports.AutoSuggest = Backbone.Form.editors.Base.extend({
                ...
                initialize:function (options) {
                    ...
                    if (this.schema.options) {
                        data = _.collect(this.schema.options, function (it) {
                            var v = that.options.key === "subjects" ? "s" : "u";
                            return {caption:it, t:v, s:'public', value:it};
                        })
                    }

                    this.autoSuggest = new AutoSuggest({
                        params:{type:options.key},
                        attributes:{name:options.key, 'class': "validate-"+options.key},
                        preFill:data
                    });
                ...
                render:function () {
                    this.$el.html(this.autoSuggest.render().el);
                    return this;
                },
                bind:function () {
                    this.autoSuggest.bind();
                },

                getValue:function () {
                    return this.autoSuggest.getValueInArray();
                }

            });
            exports.Subjects = exports.AutoSuggest.extend();
            exports.Users = exports.AutoSuggest.extend();
            exports.RadioGroup = Form.editors.Radio.extend();
            exports.SelectTable = Form.editors.Radio.extend();   //todo: need to implement select view
