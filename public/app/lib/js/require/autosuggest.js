            ...
            $.fn.autoSuggest = function(data, options) {
                ...
                if(typeof data == "function") {
                    ...
                    d_fetcher = function(query, next) {
                        ...
                        var tibbrParams =  getExtraParams().replace(/-tag-/g, encodeURIComponent(query));  //note: tibbr modification
                        request = $.getJSON(data+"?"+tibbrParams, function(data){       //note: tibbr modficaiton
                ...
                if(d_fetcher) {
                    return this.each(function(x){
                        ...
                        var values_input = $('<input type="hidden" class="as-values" name="'+opts.asHtmlName+'" id="as-values-'+x+'" />');
                        var prefill_value = "";
                        ...
                        function add_selected_item(data, num){
                            ...
                            //tibbr modification: add data-scope and data-type
                            var item = $('<li class="as-selection-item" id="as-selection-'+num+'" data-caption="'+data.caption+'" data-scope="'+ data.s +'" data-type = "'+ data.t +'" data-value="' + data[opts.selectedValuesProp] + '"></li>').click(function(){
                            ...
                            org_li.before(item.html(data[opts.selectedItemProp]).append(close)); //tibbr:modification
