    ...
    , function (jQuery) {
        ...
        return (function ($) {
            $.fn.multiEmail = function (options) {
                 ...
                 * afterAdd: [Function: null] callback function after adding email : add by tibbr
                 * afterRemove: [Function: null] callback function after removing email : add by tibbr
                 */
                var options = $.extend({
                    max:null,
                ...
                var Control = function ($inp) {
                     ...
                     */
                    var init = function () {
                        $inp.hide().attr("disabled", "disabled");
                    ...
                    var createInput = function () {
                        ...
                        //Handing blur event on  the input tibbr modifcation
                    ...
                    var validEmail = function (str) {
                        if (typeof options.validateFunction == "function") {
                            return options.validateFunction(str);
                        } else {
